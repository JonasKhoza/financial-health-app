...
router.post("/auth/signin", validateAuthData_1.signinDataValidatorArr, (0, contentTypeValidator_1.default)(contentType_1.applicationJson), users_controllers_1.signinUserUser);
router.post("/auth/profile", verifyUserAuthStatus_1.default, users_controllers_1.createUserProfile);
